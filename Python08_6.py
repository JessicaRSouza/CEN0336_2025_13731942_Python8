...
#Abrindo o arquivo FASTA (leitura) e os três arquivos de saída (escrita)
with open(arquivo, "rt") as fasta, open("Python_08.codons-6frames.nt", "w") as arquivo_saida, open("Python_08.translated.aa", "w") as arquivo_aa, open("Python_08.translated-longest.aa", "w") as arq_pept_longo:
	for line in fasta:
	...
	for identificador, sequencia in fastaDict.items():
		...
		#Criando a variável que guardará o peptídeo mais longo dos 6 quadros
		pept_mais_longo = ""
