...
#Abrindo o arquivo FASTA (leitura) e os dois arquivos de saída (escrita)
with open(arquivo, "rt") as fasta, open("Python_08.codons-6frames.nt", "w") as arquivo_saida, open("Python_08.translated.aa", "w") as arquivo_aa:
	for line in fasta:
...
print("Processamento concluído. Verifique os arquivos \"Python_08.codons-6frames.nt\" e \"Python_08.translated.aa\".")
